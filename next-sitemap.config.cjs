...
module.exports = {
    siteUrl: 'https://www.oogaooga.app', // .게시하는 site의 url
    ...
    exclude: [
        '/exclude/review', // 페이지 주소 하나만 제외시키는 
        '/exclude/**', // 하위 주소 전체를 제외시키는 경우
        '/server-sitemap.xml', //자동 생성되는 site-map 제외
    ...
    robotsTxtOptions: {
        ...
        policies: [
         ...
         additionalSitemaps: [
            'https://www.oogaooga.app/server-sitemap.xml', // <==== Add here
        ],
    } // robots.txt 옵션 설정
}